...
import { ChoosePhotoWidget, ProfileEmployeeCardWidget } from "../components/Widgets";
import { EmployeeGeneralInfoForm } from "../components/Forms";
...
export default () => {
  ...
  return (
    <>
      ...
      <Row>
        <Col xs={12} xl={8}>
          <EmployeeGeneralInfoForm employee={employee} />
        </Col>

        <Col xs={12} xl={4}>
          <Row>
            <Col xs={12}>
              <ProfileEmployeeCardWidget employee={employee}/>
            </Col>
            {/* <Col xs={12}>
              <ChoosePhotoWidget
