      ...
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div className="d-block mb-4 mb-md-0">
          <Breadcrumb className="d-none d-md-inline-block" listProps={{ className: "breadcrumb-dark breadcrumb-transparent" }}>
            ...
            <Breadcrumb.Item active>Department Details</Breadcrumb.Item>
          </Breadcrumb>
        ...
        <div className="btn-toolbar mb-2 mb-md-0">
          <Button
            as={Link}
            to={`${Routes.DepartmentEdit.path.replace(':id', id)}`}
            variant="primary"
            size="sm"
            className="me-2"
          >
          ...
          <Card.Body>
            <Row>
              ...
              <Col md={6}>
                ...
                <div className="mb-3">
                  <strong>Parent Department:</strong> {department.parentDepartment || 'None'}
                </div>
              </Col>
            </Row>
          </Card.Body>
