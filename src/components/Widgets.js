...
export const ProfileEmployeeCardWidget = ({ employee }) => {
  return (
    <Card border="light" className="text-center p-0 mb-4">
      <div style={{ backgroundImage: `url(${ProfileCover})` }} className="profile-cover rounded-top" />
      <Card.Body className="pb-5">
        ...
        <Card.Subtitle className="fw-normal">{employee.email}</Card.Subtitle>
        <Card.Text className="text-gray mb-4">{employee.currentAddress}</Card.Text>
