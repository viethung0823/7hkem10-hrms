...
import { faBook, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faToolbox, faSignOutAlt, faTable, faTimes, faUser, faFileContract, faCalendarAlt, faMapPin, faInbox, faRocket } from "@fortawesome/free-solid-svg-icons";
		...
		return (
			<Accordion as={Nav.Item} defaultActiveKey={defaultKey} activeKey={activeKeys.includes(eventKey) ? eventKey : null}>
				<Accordion.Item eventKey={eventKey}>
					<Accordion.Button as={Nav.Link} className="d-flex justify-content-between align-items-center" onClick={() => handleToggle(eventKey)}>
						<span>
			...
			<CSSTransition timeout={300} in={show} classNames="sidebar-transition">
				<SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
					<div className="sidebar-inner px-4 pt-3">
						...
						<Nav className="flex-column pt-3 pt-md-0">
							...
							<CollapsableNavItem eventKey="Profile" title="Profile" icon={faUser}>
								<NavItem title="Employees" link={Routes.Employee.path} />
								<CollapsableNavItem eventKey="Contract" title="Contract" icon={faFileContract}>
									<NavItem title="Contracts" link={Routes.Contract.path} />
								</CollapsableNavItem>
								<CollapsableNavItem eventKey="Configuration" title="Configuration" icon={faToolbox}>
									<NavItem title="Companies" link={Routes.Company.path} />
                ...
                <NavItem title="500 Server Error" link={Routes.ServerError.path} />
							...
							<CollapsableNavItem eventKey="Setting" title="Setting" icon={faCog}>
								...
								<NavItem title="Roles" link={Routes.UserRole.path} />
							</CollapsableNavItem>
